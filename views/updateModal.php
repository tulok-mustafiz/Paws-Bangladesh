...
if(isset($_POST['savechanges'])){
    $type = $_SESSION['prod_type'];
		$id = $_POST['fdid'];
		$name = $_POST['name'];
		$des = $_POST['des'];
		$stat = $_POST['stat'];
		$price = $_POST['prize'];
    $table_name = $type . "_type";
...
//     $location = "upload/" . $_FILES["image"]["name"];
        ...
        $prod_name = $type . "_name";
        $prod_des = $type . "_description";
        $prod_price = $type . "_price";
								
				$sql = ("UPDATE $table_name set $prod_name = '$name',
													   $prod_des = '$des',
													   status = '$stat',
													   $prod_price = '$price',
													   image = NULL WHERE id = '$id'") or die (mysqli_error());
